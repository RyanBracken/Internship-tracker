...
const scrapers = [
  ...
  require('./scrapers/jobboards/seek'),
  require('./scrapers/jobboards/totaljobs'),
  require('./scrapers/jobboards/reedcouk'),
  require('./scrapers/jobboards/cityfalcon'),
  require('./scrapers/jobboards/milkround'),
  require('./scrapers/jobboards/prospects'),
  require('./scrapers/jobboards/wiworc'),
  require('./scrapers/jobboards/monster'),
  require('./scrapers/jobboards/cvlibrary'),
  require('./scrapers/jobboards/stepstone'),
  require('./scrapers/jobboards/apec'),
  require('./scrapers/jobboards/jobs_ch'),
  require('./scrapers/jobboards/handshake'),
  require('./scrapers/jobboards/wayup'),
